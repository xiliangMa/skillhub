  ...
  return (
    <Link href={`/skills/${id}`}>
      <div className="group relative h-full">
        ...
        {/* Card */}
        <div className="relative h-full bg-slate-800/80 backdrop-blur-sm rounded-xl border border-slate-700/50 group-hover:border-slate-600 transition-all overflow-hidden">
          {/* Decorative elements */}
          ...
          <CardHeader className="relative">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 border border-slate-600 flex items-center justify-center">
                  <Cpu className="h-6 w-6 text-blue-400" />
                </div>
                <CardTitle className="text-xl text-white font-semibold group-hover:text-blue-400 transition-colors">
                  {name}
                </CardTitle>
              </div>
              {priceType === "free" ? (
                ...
                <Badge className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-400 border-blue-500/30 hover:from-blue-500/30 hover:to-purple-500/30">

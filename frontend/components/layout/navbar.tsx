...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-slate-800/50 bg-slate-900/80 backdrop-blur-xl supports-[backdrop-filter]:bg-slate-900/60 shadow-lg">
      <div className="container mx-auto px-4 md:px-6 flex h-16 items-center justify-between">
        <Link href="/" className="flex items-center space-x-2 group">
          <div className="relative">
            ...
            <div className="relative w-8 h-8 bg-slate-900 rounded-lg flex items-center justify-center transform group-hover:scale-110 transition-transform">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          {loading ? (
            <div className="h-9 w-20 bg-slate-800 animate-pulse rounded"></div>
          ) : user ? (
            <div className="relative">
              <Button
                variant="ghost"
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative w-8 h-8 bg-slate-900 rounded-full flex items-center justify-center">
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-slate-900/95 backdrop-blur-xl rounded-lg shadow-2xl border border-slate-700/50 py-1 animate-in slide-in-from-top-2 duration-200">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-slate-800/50 bg-slate-900/95 backdrop-blur-xl">
          <div className="p-4 space-y-4 animate-in slide-in-from-top duration-300">
            ...
            {loading ? (
              <div className="h-9 bg-slate-800 animate-pulse rounded"></div>
            ) : user ? (

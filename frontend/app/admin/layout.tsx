  ...
  const navItems: NavItem[] = [
    {
      ...
      label: t.admin?.overview || "概览",
      href: "/admin",
      description: t.admin?.overviewDesc || "数据概览和平台统计"
    },
    {
      icon: <BarChart3 className="h-5 w-5" />,
      label: t.admin?.analytics || "数据分析",
      href: "/admin/analytics",
      description: t.admin?.analyticsDesc || "详细数据分析和报告"
    },
    {
      icon: <Zap className="h-5 w-5" />,
      label: t.admin?.skillsManagement || "技能管理",
      href: "/admin/skills",
      description: t.admin?.skillsManagementDesc || "管理平台上的所有技能"
    },
    {
      icon: <Users className="h-5 w-5" />,
      label: t.admin?.usersManagement || "用户管理",
      href: "/admin/users",
      description: t.admin?.usersManagementDesc || "管理用户账户和权限"
    },
    {
      icon: <CreditCard className="h-5 w-5" />,
      label: t.admin?.ordersManagement || "订单管理",
      href: "/admin/orders",
      description: t.admin?.ordersManagementDesc || "查看和处理所有订单"
    },
    {
      icon: <Tag className="h-5 w-5" />,
      label: t.admin?.categories || "分类管理",
      href: "/admin/categories",
      description: t.admin?.categoriesDesc || "管理技能分类和标签"
    },
    {
      icon: <Settings className="h-5 w-5" />,
      label: t.admin?.settings || "系统设置",
      href: "/admin/settings",
      description: t.admin?.settingsDesc || "平台配置和参数设置"
    }
  ]
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="border-t border-slate-200 dark:border-slate-800 p-4">
                  ...
                  <Link
                    href="/dashboard"
                    onClick={() => setMobileMenuOpen(false)}
                    className="w-full flex items-center justify-center px-3 py-3 text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors mb-2"
                  >

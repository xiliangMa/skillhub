...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-400/30 bg-blue-500/10 backdrop-blur-sm">
              ...
              <span className="text-sm text-blue-400 font-mono">AI SKILLS MARKETPLACE v2.0</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-bold tracking-tight bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
              {t.home.heroTitle}
            </h1>
            ...
            <div className="max-w-2xl mx-auto w-full">
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg blur opacity-30 group-hover:opacity-50 transition duration-500" />
                <div className="relative flex items-center bg-slate-800/90 backdrop-blur-md rounded-lg border border-slate-700/50">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <Link href="/categories">
                <Button variant="outline" size="lg" className="h-14 px-8 border-slate-600 bg-slate-800/50 hover:bg-slate-700 text-base text-white">
                  {t.home.learnMore}
                </Button>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="relative group">
                ...
                <div className="relative h-full bg-slate-800/80 backdrop-blur-sm p-8 rounded-xl border border-slate-700/50 group-hover:border-slate-600 transition-all">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-700 to-slate-800 border border-slate-600 mb-6">
      ...
      {/* Hot Skills */}
      <section className="relative py-20 px-4 md:px-6 bg-gradient-to-b from-blue-900/10 to-transparent">
        <div className="container mx-auto relative z-10">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link href="/skills">
              <Button variant="outline" size="lg" className="border-slate-600 bg-slate-800/50 hover:bg-slate-700 text-white">
                {t.home.learnMore}
          ...
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="h-80 bg-slate-700/50 animate-pulse rounded-xl border border-slate-700" />
              ))}
            </div>
          ) : hotSkills.length === 0 ? (
